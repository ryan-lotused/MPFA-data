...
LIST_URL = "https://www.mpfa.org.hk/en/info-centre/useful-list/approved-pooled-investment-funds"
API_URL = "https://www.mpfa.org.hk/api/feature/dataintegration/pooledinvestmentfundsajax"
HEADING_TEXT = "Search on the List of Approved Pooled Investment Funds"
DEFAULT_POST_PAYLOAD = {
    ...
    "pifType": "",
    "investmentManager": "",
    "currentUrl": "/en/info-centre/useful-list/approved-pooled-investment-funds",
    "lang": "en",
    "pageNumber": 0,
    "pageSize": 10,
}
DATASET_DIR = Path("data/pooled_investment_funds")
DEFAULT_COOKIE_PATH = Path("output/pooled_investment_funds.cookies.json")


logger = logging.getLogger("mpfa_pooled_investment_funds")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Use Playwright cookies to fetch the MPFA approved pooled investment funds API."
    )
...
async def main() -> int:
    ...
    logger.info("Starting MPFA pooled investment fund fetch")

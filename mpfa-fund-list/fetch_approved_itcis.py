...
LIST_URL = "https://www.mpfa.org.hk/en/info-centre/useful-list/approved-itcis"
API_URL = "https://www.mpfa.org.hk/api/feature/dataintegration/data-approved-itcis"
HEADING_TEXT = "Search on the List of Approved ITCIs"
...
DATASET_DIR = Path("data/approved_itcis")
DEFAULT_COOKIE_PATH = Path("output/approved_itcis.cookies.json")


logger = logging.getLogger("mpfa_approved_itcis")


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Use Playwright cookies to fetch the MPFA approved ITCIs API."
    )
...
async def main() -> int:
    ...
    logger.info("Starting MPFA approved ITCIs fetch")
